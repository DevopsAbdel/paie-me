...
<div class="card">
    ...
    <div style="padding:0.5rem 0; display:flex; align-items:center; gap:0.5rem;">
        <button type="button" id="anc-btn-edit" class="btn btn-warning btn-sm" onclick="ancToggleEdit(true)" style="font-size:0.75rem;">
        ...
        <button type="button" id="anc-btn-add" class="btn btn-primary btn-sm" onclick="ancAjouter()" style="font-size:0.75rem; display:none;">+ Ajouter une tranche</button>
        ...
        <button type="button" id="anc-btn-cancel" class="btn btn-secondary btn-sm" onclick="ancToggleEdit(false)" style="font-size:0.75rem; display:none;">Annuler</button>
    </div>
</div>
</form>
