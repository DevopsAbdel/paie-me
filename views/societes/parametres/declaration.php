...
<div class="card">
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                <tr><td>1</td><td>Allocations Familiales</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_af, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_af, 2, ',', ' ') ?></td></tr>
                <tr><td>2</td><td>Prestations sociales à court terme</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_ps, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_ps, 2, ',', ' ') ?></td></tr>
                ...
                <tr><td>8</td><td>Taxe de la formation professionnelle</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_tfp, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_tfp, 2, ',', ' ') ?></td></tr>
...
<div class="card" style="margin-top:0.75rem;">
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                <tr><td>1</td><td>Participation AMO</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_part_amo, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_part_amo, 2, ',', ' ') ?></td></tr>
                <tr><td>2</td><td>Cotisation AMO</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_cot_amo, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_cot_amo, 2, ',', ' ') ?></td></tr>
...
<div class="card" style="margin-top:0.75rem;">
    ...
    <div class="table-wrapper">
        <table>
            ...
            <tbody>
                <tr><td>CNSS</td><td>1</td><td>Allocations Familiales</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_af, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_af, 2, ',', ' ') ?></td></tr>
                <tr><td>CNSS</td><td>2</td><td>Prestations sociales à court terme</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_ps, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_ps, 2, ',', ' ') ?></td></tr>
                <tr><td>AMO</td><td>1</td><td>Participation AMO</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_part_amo, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_part_amo, 2, ',', ' ') ?></td></tr>
                <tr><td>AMO</td><td>2</td><td>Cotisation AMO</td><td style="text-align:right;"><?= number_format($masse, 2, ',', ' ') ?></td><td style="text-align:right;"><?= number_format($taux_cot_amo, 2, ',', ' ') ?> %</td><td style="text-align:right; font-weight:600;"><?= number_format($mt_cot_amo, 2, ',', ' ') ?></td></tr>
            </tbody>
        </table>
    </div>
