            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= $baseUrl ?>/bareme_salaire?delete_bareme=<?= $b['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Supprimer ce barème ?')" style="padding:0.2rem 0.4rem; font-size:0.7rem;">✕</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
