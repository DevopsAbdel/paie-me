    ...
    <ul class="sidebar-nav">
        ...
        <li>
            ...
            <ul style="list-style:none; padding:0; margin:0.25rem 0 0 1.5rem; font-size:0.8125rem;">
                ...
                <li><a href="<?= $base ?>declaration" style="display:block; padding:0.3rem 0.5rem; color:<?= str_contains($uri, '/declaration')?'var(--accent)':'var(--text-muted)'?>; text-decoration:none; border-radius:4px;">Déclaration</a></li>
