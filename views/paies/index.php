                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                ...
                                <?php if ($p['cloturee']): ?>
                                    <a href="/paie-me/paies/<?= $p['id'] ?>/rouvrir" class="btn-icon btn-edit" title="Réouvrir" onclick="return confirm('Réouvrir cette période ? Les modifications seront à nouveau autorisées.')">
