                    ...
                    <tr>
                        ...
                        <td>
                            <div class="table-actions">
                                ...
                                <a href="/paie-me/paies/paie/<?= $pa['id'] ?>/edit" class="btn-icon btn-edit" title="Modifier">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                                </a>
                                <a href="/paie-me/paies/paie/<?= $pa['id'] ?>/supprimer" class="btn-icon btn-delete" title="Supprimer" onclick="return confirm('Supprimer la paie de <?= htmlspecialchars($pa['nom_famille'] . ' ' . $pa['prenom']) ?> ?')">
