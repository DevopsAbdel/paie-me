...
-- -----------------------------------------------------------
INSERT INTO rubriques_gains (societe_id, is_global, code, libelle, type_montant, valeur_defaut, categorie, imposable, affectation, compte, plafond_dgi, plafond_cnss, justificatifs, source, source_maj, nature_edi, base_anciennete, au_prorata) VALUES
